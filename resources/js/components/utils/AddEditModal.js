    ...
    return(
        ...
        >
            ...
            <Modal.Footer>
                ...
                >{props.txtConfirmButton!== undefined ? props.txtConfirmButton:'Aggiungi'} <img className={"loader-2"+(props.loader==true?' d-inline-block':'')} src="../img/loader_2.gif"></img></ConfirmButton>
            </Modal.Footer>
        </Modal>
    );
}
